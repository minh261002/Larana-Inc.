...
class AuthController extends Controller
{
    ...
    public function handleFacebookCallback()
    {
        ...
        if ($check && $check->login_type == UserLoginType::Email->value || $check->login_type == UserLoginType::Google->value) {
    ...
    public function handleGoogleCallback()
    {
        ...
        if ($check && $check->login_type == UserLoginType::Email || $check->login_type == UserLoginType::Facebook) {
